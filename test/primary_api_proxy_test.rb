...
class TestPrimaryApiProxy < Minitest::Test
  ...
  def test_choose_prefers_socks5_over_http_proxy
    env = {
  ...
  def test_uses_https_proxy_when_no_socks
    env = {'HTTPS_PROXY' => 'http://proxy:8080'}
    assert_equal 'http://proxy:8080', PrimaryApiProxy.resolve(nil, env)
  end

  def test_explicit_proxy_url_included_and_socks_still_preferred
    env = {'HTTPS_PROXY' => 'http://proxy:8080', 'ALL_PROXY' => 'socks://127.0.0.1:1080'}
